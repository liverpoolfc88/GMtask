...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 17 2020 г., 11:58
...
CREATE TABLE IF NOT EXISTS `yangilik_maxsulot` (
  ...
  `maxsulot_add` varchar(255) NOT NULL,
  `maxsulot_update` varchar(255) NOT NULL,
...
INSERT INTO `yangilik_maxsulot` (`id`, `maxsulot_name`, `maxsulot_photo`, `maxsulot_short`, `maxsulot_add`, `maxsulot_update`, `user_id`) VALUES
(30, 'olma', 'img/5e503675ebc39.jpg', 'olmalar', 'Lfc', 'sardor', NULL),
(39, 'gilos', 'img/5e5036687fe90.jpg', 'Erta baxorgi giloslar', 'sardor', 'liverpool', NULL),
(40, 'anor', 'img/367541755.jpg', 'Qizil shirin anor', 'sardor', 'sardor', NULL);
